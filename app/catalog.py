...
REPORT_DEFINITIONS = {
    "ozon": {
        ...
        "metrics": [
            ...
            {"code": "abc_red_sku", "label": "SKU в красной зоне", "unit": "шт", "has_plan": True, "direction": "down"},
            {"code": "abc_yellow_sku", "label": "SKU в желтой зоне", "unit": "шт", "has_plan": True, "direction": "down"},
            {"code": "abc_work_sku", "label": "SKU в рабочей зоне", "unit": "шт", "has_plan": True, "direction": "up"},
    ...
    "finance": {
        ...
        "metrics": [
            {"code": "cash_on_accounts_rub", "label": "Деньги на счетах", "unit": "₽", "has_plan": True, "direction": "up"},
            ...
            {"code": "company_profit_pct", "label": "ROS", "unit": "%", "has_plan": True, "direction": "up"},
            {"code": "roi_pct", "label": "ROI", "unit": "%", "has_plan": True, "direction": "up"},
            {"code": "balance_rub", "label": "Баланс", "unit": "₽", "has_plan": True, "direction": "up"},
